...
- "Name=?"  - ogólnie: warunek, który określa, które wiersze należy zaktualizować; "NAME = ?" oznacza, że chcemy zaktualizować wiersze, gdzie wartość w kolumnie "NAME" jest równa 
