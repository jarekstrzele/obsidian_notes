...
      />
      {modalIsVisible && <GoalInput visibile={modalIsVisible}
...
```python
 <Modal visibile={props.visibile} animationType="slide">
  <Modal visibile={props.visibile} animationType="fade">
   <Modal visibile={props.visibile} animationType="none">
```
