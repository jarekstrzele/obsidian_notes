...
>kiedy korzystać z aliasu typu, a kiedy z interfejsu? Zarówno aliasy typu, jak i interfejsy oferują podobne możliwości tworzenia typów obiektów, więc krótko mówiąc — to kwestia indywidualnych preferencji. Niemniej aliasy typu oferują pewne funkcje, których interfejsy nie mają, jak na przykład typ union
