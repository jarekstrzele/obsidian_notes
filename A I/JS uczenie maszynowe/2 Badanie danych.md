...
**uczenie maszynowe**
- wyorzystanie wielkiego zbioru danych
- prawdopodobieństwo
- statystyka
- algebra liniowa
- rachunek wektorowy
...
- CNN przetwarza obrazy, ale nie dowole, lecz taki, które spełniają odpowiednie wymagania (np. kolory, rozmiar, ilość pikseli)
