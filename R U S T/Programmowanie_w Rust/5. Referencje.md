...
- np:
	...
	- referencja  do obiektu implementującego zestaw metod (adres obiektu + adres implementacji zestawu metod, które dla tej wartośći mogą być wywoływane)
...
WYJAŚNIENIE:
- dla każdej referencji Rust próbuje zdefiniować czas jej życia i zbadać ograniczenia
